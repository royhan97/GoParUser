...
import project.roy.socialmedia.ui.BaseActivity;
...
//                        LogUtil.logDebug(TAG, "Glide Success Loading image from uri : " + imageUri.getPath());
    ...
    protected boolean isImageFileValid(Uri imageUri) {
        ...
        if (!result) {
            ShowAlert.showToast(this, String.valueOf(message));
            getProgressView().setVisibility(View.GONE);
        }
...
//               gUtlogDebug(TAG, "CAMERA_CAPTURE_PERMISSIONS granted");
                ...
                ShowAlert.showToast(this,getResources().getString(R.string.permissions_not_granted));
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                if (ValidationUtil.checkImageMinSize(result.getCropRect())) {
                    ...
                    ShowAlert.showToast(this,getResources().getString(R.string.error_smaller_image));
                }
            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
//                LogUtil.logError(TAG, "crop image error", result.getError());
                ShowAlert.showToast(this,getResources().getString(R.string.error_fail_crop_image));
            }
        }
    }
    ...
    protected void startCropImageActivity() {
        ...
        CropImage.activity(imageUri)
                ...
                .setMinCropResultSize(Constant.Profile.MIN_AVATAR_SIZE, Constant.Profile.MIN_AVATAR_SIZE)
                .setRequestedSize(Constant.Profile.MAX_AVATAR_SIZE, Constant.Profile.MAX_AVATAR_SIZE)
                .start(this);
    }
}
