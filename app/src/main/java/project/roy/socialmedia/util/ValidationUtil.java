...
public class ValidationUtil {
    ...
    public static boolean isPostTitleValid(String name) {
        return name.length() <= Constant.Post.MAX_POST_TITLE_LENGTH;
    }

    public static boolean isNameValid(String name) {
        return name.length() <= Constant.Profile.MAX_NAME_LENGTH;
    }
    ...
    public static boolean checkImageMinSize(Rect rect) {
        return rect.height() >= Constant.Profile.MIN_AVATAR_SIZE && rect.width() >= Constant.Profile.MIN_AVATAR_SIZE;
    }
}
